...
public interface Commons {
    ...
    public static final int NUMBER_OF_ALIENS_TO_DESTROY = 24;   // linkedList GAME
    public static final int CHANCE = 5;                         // LIVES
    public static final int DELAY = 17;                     
    public static final int PLAYER_WIDTH = 15;                  // Player CLASS
    public static final int PLAYER_HEIGHT = 10;                 // Player CLASS
